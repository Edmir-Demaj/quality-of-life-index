...
def specific_data(index):
    ...
    if answer == "yes":
        clean_screen()
        print(f"{ts.G}Purchasing Power Index {index[0]}: {index[2][3]}")
        print("Higher is better 0-100\n")
        time.sleep(1)
        print(f"{ts.R}Pollution Index {index[0]}: {index[2][9]}")
        print("Lower is better 0-100\n")
        time.sleep(1)
        print(f"{ts.R}House Price to Income Index {index[0]}: {index[2][7]}")
        print("Lower is better 0-100\n")
        time.sleep(1)
        print(f"{ts.R}Cost of Living Index {index[0]}: {index[2][6]}")
        print("Lower is better 0-100\n")
        time.sleep(1)
        print(f"{ts.G}Safety Index {index[0]}: {index[2][4]}")
        print("Higher is better 0-100\n")
        time.sleep(1)
        print(f"{ts.G}Health Care Index {index[0]}: {index[2][5]}")
        print("Higher is better 0-100\n")
        time.sleep(1)
        print(f"{ts.R}Traffic Commute Time Index {index[0]}: {index[2][8]}")
        print("Lower is better 0-100\n")
        time.sleep(1)
        print(f"{ts.G}Climate Index {index[0]}: {index[2][10]}")
        print("Higher is better 0-100")
        time.sleep(6)
        clean_screen()
        other_country()
